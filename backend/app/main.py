...
from .api.routes import recommendations, digital_twin, graph_routes, eta_routes
...
def create_app() -> FastAPI:
	...
	app = FastAPI(
		title="RailPulse-X Backend",
		description="Dynamic Train ETA Forecasting Service (SIH26028 - Ministry of Railways)",
		version="2.0.0",
	)
	...
	# RailPulse-X Dynamic ETA Forecasting API (SIH26028)
	app.include_router(eta_routes.router)
